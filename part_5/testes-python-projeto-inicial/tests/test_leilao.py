...
# classes de equivalÊncia-> quando ah classes de teste que testa
# a mesma coisa, então é melhor fazer apenas um geral
# code smell-> mau cheiro de código
# setUp-> cenario de teste
# Lei de dementer -> devemos ter o menor conhecimento da classe
# Cópia rasa -> todos os elementos da lista tem a mesma referência
# teste de regressão -> testes já foram feitos que também tiveram a função de testar as funcionalidades futuras
# teste de sistema
# teste de integração
