...
class Usuario:
    ...
    def proproe_lance(self, leilao, valor: float):
        if not self.__valor_eh_valido(valor):
            raise LanceInvalido('Nao pode dar lance maior que o da carteria')
...
class Leilao:
    ...
    @property
    def lances(self):
        return self.__lances[:] # devolver uma cópia da lista de lances
