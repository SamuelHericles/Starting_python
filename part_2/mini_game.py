...
if(__name__ == "__main__"):# para controlar a execução,se chamar a função, a vairavel __name__ é preenchida pela __main__
	#__name__ e __main__ são os motores do python 
	jogar() # Com isso posso executar o arquivo sem precisar do arquivo escolha.py